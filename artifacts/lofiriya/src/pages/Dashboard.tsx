...
function LoginScreen() {
  return (
    <div className="pt-20 min-h-screen relative overflow-hidden bg-background flex items-center justify-center">
      <div className="absolute inset-0 pointer-events-none">
        <div className="aurora-blob w-[500px] h-[500px] bg-primary/20 top-[-10%] left-[-10%] rounded-full" />
        <div className="aurora-blob w-[400px] h-[400px] bg-accent/15 bottom-[-10%] right-[-10%] rounded-full"
          style={{ animationDelay: '-6s' }} />
      </div>
      <motion.div initial={{ opacity: 0, y: 32 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}
        className="relative z-10 bg-surface border border-white/10 rounded-3xl p-10 max-w-md w-full mx-4 text-center shadow-2xl">
        ...
        <Button asChild size="lg"
          className="w-full bg-[#5865F2] hover:bg-[#4752c4] text-white font-semibold rounded-xl gap-3 h-12">
        ...
        <p className="text-xs text-muted-foreground mt-6 opacity-60">
          We only request <code>identify</code>, <code>guilds</code> and <code>email</code> scopes.
